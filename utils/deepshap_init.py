...
class DeepExplainer(Explainer):
    ...
    def shap_values(self, X, ranked_outputs=None, output_rank_order='max', get_max_output=-1, mini_batch=200):
        ...
        # add extra parameter get_max_output, Added by Snow 19 Sep, 2019
        return self.explainer.shap_values(X, ranked_outputs, output_rank_order, get_max_output, mini_batch)
