...
from fairseq.fairseq.models import FairseqEncoder, FairseqDecoder


def save_checkpoint(args, trainer, epoch_itr, val_loss):
    from fairseq.fairseq import distributed_utils, meters
...
def _upgrade_state_dict(state):
    ...
    from fairseq.fairseq import models, registry, tasks
