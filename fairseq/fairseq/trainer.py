...
from fairseq.fairseq import checkpoint_utils, distributed_utils, models, optim, utils
...
class Trainer(object):
    ...
    def train_step(self, samples, dummy_batch=False, raise_oom=False):
        ...
        try:
            ...
            self.meters['clip'].update(
                1. if grad_norm > self.args.clip_norm > 0 else 0.
            )
    ...
    def valid_step(self, sample, raise_oom=False):
        ...
        try:
            ...
            if 'out of memory' in str(e) and not raise_oom:
                ...
                raise e
        # End temporary changed by Snow Aug 26, 2019
    ...
    def set_dummy_batch(self, dummy_batch):
        self._dummy_batch = dummy_batch
