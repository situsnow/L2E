...
def parse_args_and_arch(parser, input_args=None, parse_known=False):
    ...
    from fairseq.fairseq.registry import REGISTRIES
...
def get_parser(desc, default_task='translation'):
    ...
    parser.add_argument("--print-log-file", type=str, help='the path to print the stdout')
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    if train:
        ...
        group.add_argument('--valid-subset', default='valid,test', metavar='SPLIT',
...
def add_model_args(parser):
    ...
    from fairseq.fairseq.models import ARCH_MODEL_REGISTRY
