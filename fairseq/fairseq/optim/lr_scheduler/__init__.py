...
from fairseq.fairseq.optim.lr_scheduler.fairseq_lr_scheduler import FairseqLRScheduler
...
for file in os.listdir(os.path.dirname(__file__)):
    if file.endswith('.py') and not file.startswith('_'):
        ...
        importlib.import_module('fairseq.fairseq.optim.lr_scheduler.' + module)
